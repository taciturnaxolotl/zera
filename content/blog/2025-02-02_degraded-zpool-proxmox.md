...
[extra]
standard_site_uri = "at://did:plc:krxbvxvis5skq7jj6eot23ul/site.standard.document/3mnmzfmtwjk25"
+++
...
![the zpool reporting a downed disk](https://l4.dunkirk.sh/i/tN1RfSRLAeo2.webp){caption="That really scared the pants off me when I first saw it 😂"}
...
![chick-fil-a macaroni and cheese with 2 nuggets and some ketchup](https://l4.dunkirk.sh/i/9tkdGhqIYmxt.webp){caption="My case situation is a bit of a mess and I'm using old 7200rpm server drives for pretty much everything; the dream is a 3 drive 2 TB each m.2 nvme ssd setup, maybe someday 🤷"}
...
![the zpool reporting a downed disk](https://l4.dunkirk.sh/i/2fbRM2bxdHKc.webp){caption="It's slow but faster then I expected for HDDs"}
