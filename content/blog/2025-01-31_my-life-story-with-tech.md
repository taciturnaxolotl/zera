...
![2 boxes of electronics sitting on a closet shelf](https://l4.dunkirk.sh/i/_nNZW8nDrtsX.webp){caption="I still have that same rpi today! It's joined with all the random tech bits in two enormously heavy bins in my closet"}
...
![purple bubble logo](https://l4.dunkirk.sh/i/nvbGwaMylcQ2.webp){caption="I loved working on purple bubble 💖 i worked with some pretty incredible people and learned a ton. ik know yall are probably reading this when rss drops it so 🫶"}
...
![the cockroach charges in hcb](https://l4.dunkirk.sh/i/QifqA0Ob4VJZ.webp){caption="The price really sky rocketed as we started using it in prod 😂"}
