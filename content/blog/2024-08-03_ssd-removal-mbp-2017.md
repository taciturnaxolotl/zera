...
![Removing the screws](https://l4.dunkirk.sh/i/QtJUiXMSX-lY.webp)
...
![using a suction cup to lift the back shell](https://l4.dunkirk.sh/i/GdbMMR4JBh6x.webp)
...
![the opened MacBook](https://l4.dunkirk.sh/i/vrohFehEFZ0r.webp)

1. once it's open, locate the silver metal block looking thing; this is your SSD
![the SSD](https://l4.dunkirk.sh/i/y2s-Zcdt-FL6.webp)
...
![the screws](https://l4.dunkirk.sh/i/brqIWi0VeSAX.webp)
...
![the removed tape on the SSD](https://l4.dunkirk.sh/i/aG0xcxZMN9Kq.webp)

1. now just slightly pull on the SSD (again at a slight angle) and it should pop right out!
![the SSD out of the MacBook](https://l4.dunkirk.sh/i/RlA6xfMC8qdi.webp)
