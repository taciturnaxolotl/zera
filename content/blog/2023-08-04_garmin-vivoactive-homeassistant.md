...
[extra]
standard_site_uri = "at://did:plc:krxbvxvis5skq7jj6eot23ul/site.standard.document/3mnmzflu3xs25"
+++
...
![a garmin watch with the apicall app open to a spotify page](https://l4.dunkirk.sh/i/9xmYg_HE3KCn.webp){caption="I can control spotify from my watch via api hooks how bout you?"}
...
![arrow pointing to settings in home assistant](https://l4.dunkirk.sh/i/ibVO3Z1trZhn.webp)
![arrow pointing to Automations & Services in home assistant](https://l4.dunkirk.sh/i/ZGVec6P_sHUb.webp)
...
![creating a new webhook in home assistant](https://l4.dunkirk.sh/i/3EZvrvOFVNDk.webp)
...
![editing the webook in home assistant to allow GET queries](https://l4.dunkirk.sh/i/txErwYEwd9N2.webp)
![adding a play media block to the webhook](https://l4.dunkirk.sh/i/5kxiONy6zY28.webp)
...
![garmin express app homepage on desktop](https://l4.dunkirk.sh/i/7YU--efbSV7Y.webp)
...
![ApiCall settings page](https://l4.dunkirk.sh/i/yS4VBx2LyATq.webp){caption="Yes that formatting is atrocious but it works at least!"}
...
![ApiCall icons](https://l4.dunkirk.sh/i/c1U_5651OqAH.webp)
